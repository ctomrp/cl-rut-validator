/**
 * Accepts a RUT normalized (you can use rutNormalizer()). e.g.: 11222333k
 * @param rutNormalized Normalized RUT returned by rutNormalizer()
 * @returns Returns true if RUT is valid, false if RUT is not valid
 */
